          ...
          <table class="table table-striped table-bordered">
            ...
            <tbody>
              ...
              ?>
                <tr>
                  <td>
                    <div class="input-group mb-3"><input class="form-control" readonly value="<?php echo $redeem['redeem']; ?>" id="<?php echo $redeem['redeem']; ?>">
                      <div class="input-group-append"><button class="btn btn-success" onclick="copyinput('<?php echo $redeem['redeem']; ?>');">Copy !</button></div>
                    </div>
                  </td>
