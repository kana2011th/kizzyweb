<?php
if ($_POST['id'] == '' || !is_numeric($_POST['id'])) die('Gift');
...
try {
  ...
  if ($e->getMessage() == 'Failed to receive challenge.') die('Server');
}
if (!in_array($user['username'], $Player)) die('Online');
if ($user['isLogged'] == 0) die('GLogin');
