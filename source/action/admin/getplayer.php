  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Edit <?php echo $data['username']; ?> #<?php echo $data['id']; ?></h5>
      ...
      <div class="modal-body">
        <div class="form-row">
          <div class="col-md-12 mb-3">
            ...
            <input type="text" class="form-control" id="eusername" placeholder="Username" required value="<?php echo $data['username']; ?>">
          </div>
          <div class="col-md-12 mb-3">
            <label for="eserverip">Point</label>
            <input type="number" class="form-control" id="epoint" placeholder="Point" value="<?php echo $data['point']; ?>">
          </div>
          <div class="col-md-12 mb-3">
            ...
            <div class="input-group">
              <select class="custom-select" id="isadmin">
                ...
                <option value="1" <?php if ($data['isadmin'] == 1) echo "selected"; ?>>Admin</option>
              </select>
            </div>
          </div>
        </div>
      ...
      <div class="modal-footer">
        ...
        <button class="btn btn-primary" onclick="save_player(<?php echo $data['id']; ?>);" data-dismiss="modal">Save !</button>
      </div>
    </div>
  </div>
</div>
