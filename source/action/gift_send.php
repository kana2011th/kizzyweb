...
if ($_POST['reciver'] == '' || $_POST['id'] == '') die('Parameter');
...
if (!$update->execute(array($_SESSION['point'], $_SESSION['id']))) die('Error');
die($_SESSION['point']);
